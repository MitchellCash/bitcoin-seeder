...
static const string mainnet_seeds[] = {"seed.wagerr.mitchellcash.com", ""};
static const string testnet_seeds[] = {"testnet-seed.wagerr.sipa.com",
                                       ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 55002), true);
  }
  do {
